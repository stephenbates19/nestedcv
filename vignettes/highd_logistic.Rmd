...
It looks like the estimate is relatively stable, so we have taken enough splits. Based on this 
plot, we see that our confidence intervals will be a bout 1.5 times wider than the naive CV intervals.
